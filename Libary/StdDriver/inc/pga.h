 ...
 **PGA 放大倍数
---------------------------------------------------------------------------*/
#define 	PAG_GAIN_1		(0x0)			/*1 倍*/
#define 	PAG_GAIN_2		(0x1)			/*2 倍*/
#define 	PAG_GAIN_4		(0x2)			/*4 倍*/
#define 	PAG_GAIN_8		(0x3)			/*8 倍*/
#define 	PAG_GAIN_16		(0x4)			/*16 倍*/
#define 	PAG_GAIN_32		(0x5)			/*32 倍*/
#define 	PAG_GAIN_64		(0x6)			/*64 倍*/
#define 	PAG_GAIN_128	(0x7)			/*128 倍*/
